...
// Modified by Homa Alemzadeh 3/29/2021, ha4d@virginia.edu
...
void Thread7(void){  // foreground thread
  UART_OutString("\n\rAdvanced Embedded Systems, Mini Project 4 Preparation\n\r");
...
int Testmain5(void){       // Testmain5 Mini Project 4
  PortE_Init();
	UART_Init();
	BSP_LCD_OutputInit();
  OS_Init();           // initialize, disable interrupts
...
void OutputThread(void){  // foreground thread
  UART_OutString("\n\rECE 4501/6501, Mini Project 4 Preparation\n\r");
...
int Testmain6(void){      // Testmain6  Mini Project 4
